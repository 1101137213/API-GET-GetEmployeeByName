...
namespace KuasCoreTests.Dao
{
    ...
    public class EmployeeDaoUnitTest : AbstractDependencyInjectionSpringContextTests
    {
        ...
        public void TestEmployeeDao_AddEmployee()
        {
            ...
            Employee dbEmployee = EmployeeDao.GetEmployeeByName(employee.Id);
            ...
            dbEmployee = EmployeeDao.GetEmployeeByName(employee.Id);
        ...
        {
            // 取得資料
            Employee employee = EmployeeDao.GetEmployeeByName("dennis_yen");
        ...
        public void TestEmployeeDao_DeleteEmployee()
        {
            ...
            Employee dbEmployee = EmployeeDao.GetEmployeeByName(newEmployee.Id);
            Assert.IsNotNull(dbEmployee);

            EmployeeDao.DeleteEmployee(dbEmployee);
            dbEmployee = EmployeeDao.GetEmployeeByName(newEmployee.Id);
            Assert.IsNull(dbEmployee);
        }
