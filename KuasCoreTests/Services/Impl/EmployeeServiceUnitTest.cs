...
namespace KuasCoreTests.Services
{
    ...
    public class EmployeeServiceUnitTest : AbstractDependencyInjectionSpringContextTests
    {
        ...
        public void TestEmployeeService_AddEmployee()
        {
            ...
            Employee dbEmpolyee = EmployeeService.GetEmployeeByName(empolyee.Id);
            ...
            dbEmpolyee = EmployeeService.GetEmployeeByName(empolyee.Id);
        ...
        {
            // 取得資料
            Employee empolyee = EmployeeService.GetEmployeeByName("dennis_yen");
        ...
        public void TestEmployeeService_DeleteEmployee()
        {
            ...
            Employee dbEmpolyee = EmployeeService.GetEmployeeByName(newEmpolyee.Id);
            Assert.IsNotNull(dbEmpolyee);

            EmployeeService.DeleteEmployee(dbEmpolyee);
            dbEmpolyee = EmployeeService.GetEmployeeByName(newEmpolyee.Id);
            Assert.IsNull(dbEmpolyee);
        }
